...
# # TEST DYLA FILES (files w/ normalized lag times)
# dir_input_ext = Path(
...
dyla.DynamicLagRemover(
    # indir=Path(r'A:\FLUXES\CH-DAV\ms_CH-DAV_non-CO2\tests_dynamic_lag\JOSS_paper\2_DYLA_output_paper\3-1_____Normalized_Files'),
    indir=Path(r'A:\FLUXES\CH-DAV\ms_CH-DAV_non-CO2\tests_dynamic_lag\JOSS_paper\1_FISP_output\splits'),
    outdir=Path(r'A:\FLUXES\CH-DAV\ms_CH-DAV_non-CO2\tests_dynamic_lag\JOSS_paper\2_DYLA_output'),
    ...
    lgs_winsize=300,  # Window size +/-, given as number of records
    ...
    # lgs_lagsig='co2_ppb_qcl_turb_DYLA',  # Lagged signal
