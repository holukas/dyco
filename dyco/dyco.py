...
def main(args):
    ...
    #     file_generation_res='30T',  # One file generated every 30 minutes
    #     file_duration='30T',  # Duration of one data file is 30 minutes
    #     lgs_num_iter=2,  # Number of lag search iterations in Phase 1 and 2 (Phase 3 is only 1 iteration)
