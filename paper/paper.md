...
As `DYCO` aims to complement current flux processing schemes. `DYCO` uses EC raw data files as input and produces final lag-removed files that can be directly used in current flux calculation software. 
...
![Normalization example](fig_PHASE-1_ITERATION-3_TIMESERIES-PLOT_segment_lag_times_iteration-1612269182193.png)
